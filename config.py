...
class Config: 
    ...
    SQLALCHEMY_DATABASE_URI=os.environ.get('DATABASE_URL') or 'sqlite:///naurish_a_g_stores.db'
  #'postgresql://naurisha_gstores_user:5HNvexMQXLtCTWDeP1C2fssc0wFjxLVA@dpg-cocc7pol5elc739qbqsg-a/naurisha_gstores'
