...
from wtforms import StringField, PasswordField, FloatField, IntegerField, RadioField, TextAreaField, SelectField, DateField, DecimalField, DateTimeField, SubmitField, SelectMultipleField, FieldList, FormField
...
class AddProductVarietyForm(FlaskForm):
    ...
    quantity_in_stock = IntegerField('Quantity in Stock', validators=[DataRequired(), NumberRange(min=1, message="Quantity must be at least 1")])
...
class AddProductForm(FlaskForm):
  ...
  quantity_in_stock = IntegerField('Quantity in Stock', validators=[Optional(), NumberRange(min=0)])
